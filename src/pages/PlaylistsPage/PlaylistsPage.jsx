...
export default function PlaylistsPage() {
  ...
  // state for total number of playlists reported by the API
  ...
  useEffect(() => {
    ...
    fetchUserPlaylists(token, limit)
      .then(res => {
        ...
        // use API-reported total when available so the UI reflects real count
        if (res.data && typeof res.data.total === 'number') setTotal(res.data.total);
      })
