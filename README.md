[![Build and Test](https://github.com/cdelezin/Music_Discovery_App/actions/workflows/ci.yml/badge.svg)](https://github.com/cdelezin/Music_Discovery_App/actions/workflows/ci.yml) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=cdelezin_Music_Discovery_App&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=cdelezin_Music_Discovery_App)  [![Coverage](https://sonarcloud.io/api/project_badges/measure?project=cdelezin_Music_Discovery_App&metric=coverage)](https://sonarcloud.io/summary/new_code?id=cdelezin_Music_Discovery_App)
